!(function (e, t) {
  ...
  function Be(e, t, n) {
    for (let r, i = t ? ce.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
  ...
  ce.extend({
    ...
    cleanData: function (e) {
      for (let t, n, r, i = ce.event.special, o = 0; void 0 !== (n = e[o]); o++)
        if ($(n)) {
          if ((t = n[_.expando])) {
            if (t.events)
              for (r in t.events)
    ...
    ce.each(
      ...
      function (e, a) {
        ce.fn[e] = function (e) {
          for (let t, n = [], r = ce(e), i = r.length - 1, o = 0; o <= i; o++)
  ...
  ce.extend({
    ...
    ce.each({ margin: "", padding: "", border: "Width" }, function (i, o) {
      (ce.cssHooks[i + o] = {
        expand: function (e) {
          for (
            let t = 0, n = {}, r = "string" == typeof e ? e.split(" ") : [e];
            t < 4;
            t++
          )
